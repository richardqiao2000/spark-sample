...
public class UserVisitSessionAnalyzeSpark {
  ...
  public static JavaPairRDD<String, Row> getSessionid2ActionRDD(JavaRDD<Row> actionRDD) {
    ...
    /**
     * PairFunction 第一个参数，相当于是函数的输入
     * 第二个参数和第三个参数，相当于是函数的输出（Tuple），分别是Tuple第一个和第二个值
     * 
     * 如果是个javardd<object1>.mapToPair PairFunction 的输入是个 object1
     * 
     * 如果是个JavaPairRDD<object1,object2>.mapToPair PairFunction 的输入是个
  ...
  private static JavaPairRDD<String, String> filterSessionAndAggrStat(
    ...
    JavaPairRDD<String, String> filteredSessionid2AggrInfoRDD = sessionid2AggrInfoRDD.filter(
        // Function 和 PairFunction 一样 input Tuple2<String,String>
        // 返回是个Boolean

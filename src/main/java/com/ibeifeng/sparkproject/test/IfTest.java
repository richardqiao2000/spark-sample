...
public class IfTest {
  ...
  public static void main(String[] args) {
    SparkConf conf = new SparkConf().setMaster("local").setAppName("IfTest");
    ...
    DataFrame gradeLevelDF = sqlContext.sql("SELECT IF(grade>=80,'GOOD','BAD') gradeLevel " + "FROM grades");

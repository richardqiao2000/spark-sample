...
public class GenerateMockData {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      String[] searchKeywords = new String[] { "火锅", "蛋糕", "重庆辣子鸡", "重庆小面", "呷哺呷哺", "新辣道鱼火锅", "国贸大厦", "太古商场",
          "日本料理", "温泉" };
        ...
        for (int j = 0; j < 10; j++) {
          ...
          for (int k = 0; k < random.nextInt(100); k++) {
            ...
            bw.write(date + "" + userid + "" + sessionid + "" + pageid + "" + actionTime + ""
                + searchKeyword + "" + clickCategoryId + "" + clickProductId + "" + orderCategoryIds
                + "" + orderProductIds + "" + payCategoryIds + "" + payProductIds + ""
                + random.nextInt(10) + "\n");
          }
        }
      }
    ...
    try {
      ...
      for (int i = 0; i < 100; i++) {
        ...
        bw.write(userid + "" + username + "" + name + "" + age + "" + professional + "" + city + "" + sex
            + "\n");
      }
    } catch (Exception e) {
      e.printStackTrace();
